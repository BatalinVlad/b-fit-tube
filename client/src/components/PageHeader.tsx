    ...
    <div className="flex gap-10 lg:gap-20 justify-between p-2 mb-6 mx-4 ">
      ...
      >
        <Button
          ...
          className={`md:hidden ${showFullWidthSearch ? "flex" : "hidden"}`}
          size="icon"
          variant="ghost"
        >
          <ArrowLeft />
        ...
        <div className="flex flex-grow mx-w-[600px]">
          <input
            type="search"
            placeholder="Search"
            className="rounded-l-full py-1 px-4 text-lg w-full border border-secondary-border shadow-inner shadow-secondary focus:border-blue-500 outline-none"
          />
          <Button
            type="button"
